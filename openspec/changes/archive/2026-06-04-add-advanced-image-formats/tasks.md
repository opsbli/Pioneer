...
**估时**：1h  
**文件**：`packages/core/src/loaders/types.ts`
...
### 任务 1.2：扩展 MIME 类型映射
**估时**：30min  
**文件**：`packages/core/src/utils/mimeTypes.ts`
...
**估时**：1.5h  
**文件**：`packages/core/src/loaders/registry.ts`
...
**估时**：2h  
**文件**：`packages/core/src/loaders/heicLoader.ts`
...
**估时**：2.5h  
**文件**：
- `packages/react/src/renderers/ImageRenderer.tsx`
- `packages/vue/src/renderers/ImageRenderer.vue`
...
- [x] 在 JSX 中显示解码状态界面
  ```tsx
  {decoding && (
    <div className="pio-decoding-overlay">
      <Loader2 className="animate-spin" />
      <p>正在解码... {decodeProgress}%</p>
    </div>
  )}
  {decodeError && (
    <div className="pio-error">
      <AlertCircle />
      <p>{decodeError}</p>
    </div>
  )}
...
**估时**：1h  
**文件**：
- `packages/react/src/renderers/ImageRenderer.css`
- `packages/vue/src/renderers/ImageRenderer.css`

- [x] 新增 `.pio-decoding-overlay` 样式（半透明遮罩 + 居中 spinner）
- [x] 新增 `.pio-error` 样式（错误提示框，红色边框 + 图标）
...
**估时**：1.5h  
**文件**：`packages/core/tests/loaders/heicLoader.test.ts`
...
**估时**：2h  
**文件**：`packages/core/src/loaders/avifLoader.ts`
...
**估时**：3h  
**文件**：`packages/core/src/loaders/tiffLoader.ts`
...
**估时**：2.5h  
**文件**：`packages/core/src/workers/imageDecoder.worker.ts`
...
**估时**：3h  
**文件**：`packages/core/src/loaders/rawLoader.ts`
...
- [x] 显示提示条：
  ```tsx
  <div className="pio-quality-notice">
    ⚠️ 这是预览缩略图（非完整像素）
...
**估时**：2.5h  
**文件**：`packages/core/src/loaders/psdLoader.ts`
...
**估时**：2h  
**文件**：
- `packages/core/tests/loaders/rawLoader.test.ts`
- `packages/core/tests/loaders/psdLoader.test.ts`
...
**估时**：2h  
**文件**：`packages/core/src/loaders/jp2Loader.ts`
