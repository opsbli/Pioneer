...
**受影响的文件**：
- `packages/react/src/renderers/base.types.ts` - 扩展 RendererHandle 接口
- `packages/react/src/PioneerContent.tsx` - 移除轮询，添加事件监听
- `packages/react/src/renderers/Image/index.tsx` - 添加事件触发
- `packages/react/src/renderers/Pdf/index.tsx` - 添加事件触发
- `packages/react/src/renderers/Epub/index.tsx` - 添加事件触发
- `packages/react/src/renderers/Mobi/index.tsx` - 完成重构 + 事件触发
- `packages/react/src/renderers/Text/index.tsx` - 完成重构 + 事件触发
- `packages/react/src/renderers/Markdown/index.tsx` - 完成重构 + 事件触发
