...
- 新增 i18n key：`font.metadata_loading`、`font.metadata_unavailable`（在 `core` 共享 messages 中补全 zh-CN / en-US）。
...
- 代码：
  - [packages/react/src/renderers/Font/index.tsx](packages/react/src/renderers/Font/index.tsx)
  - [packages/vue/src/renderers/Font/index.vue](packages/vue/src/renderers/Font/index.vue)
  - [packages/vue/src/renderers/Font/FontPreviewLine.vue](packages/vue/src/renderers/Font/FontPreviewLine.vue)（`font` 改为可空）
  - 删除：`packages/react/src/renderers/Font/wawoff2.worker.ts`、`emscriptenEnvShim.ts`、`src/types/wawoff2.d.ts`、对应的 Vue 包文件。
- 配置：
  - [packages/react/vite.config.ts](packages/react/vite.config.ts)、[packages/vue/vite.config.ts](packages/vue/vite.config.ts)
  - [packages/react/package.json](packages/react/package.json)、[packages/vue/package.json](packages/vue/package.json)：移除 `wawoff2` 依赖。
- i18n：[packages/core/src/i18n/messages/zh-CN.ts](packages/core/src/i18n/messages/zh-CN.ts)、[packages/core/src/i18n/messages/en-US.ts](packages/core/src/i18n/messages/en-US.ts)
