...
<tr>
  <td>
    • <a href="https://opsbli.github.io/Pioneer/docs/">完整文档</a><br>
    • <a href="https://opsbli.github.io/Pioneer/">React 在线演示</a><br>
  ...
  <td>
    ...
    • <a href="https://github.com/opsbli/Pioneer/blob/master/CONTRIBUTING.md">贡献指南</a>
  </td>
</tr>
</table>
...
<img src="https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/svg/1f449.svg" width="16" height="16" alt="👉" style="vertical-align: middle;" /> [查看 React 完整文档](./packages/react/README.zh-CN.md) | [在线演示](https://opsbli.github.io/Pioneer/)
...
<img src="https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/svg/1f449.svg" width="16" height="16" alt="👉" style="vertical-align: middle;" /> [查看 Vue 完整文档](./packages/vue/README.zh-CN.md) | [在线演示](https://opsbli.github.io/Pioneer/vue/)
...
<img src="https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/svg/1f449.svg" width="16" height="16" alt="👉" style="vertical-align: middle;" /> [查看完整格式列表和示例](https://opsbli.github.io/Pioneer/docs/guide/supported-types.html)
...
Office 文件（docx/xlsx/pptx）是预览链路中最重的负载——网络下载加格式转换。
Pioneer 的 core 围绕两个模块直击这一瓶颈：

- **`cache`（缓存）** — 两级缓存，统一异步 `PreviewCache` 接口：
  - `MemoryCache`：会话级 LRU，缓存转换结果（docx→HTML、xlsx→sheet 数据）
  - `StorageCache`：IndexedDB 持久化，缓存原始文件 `ArrayBuffer`，刷新页面后仍可命中
- **`stream`（流式加载）** — `ReadableStream` 分块拉取，实时回报进度（`loaded`/`total`/`percent`），支持 `AbortSignal` 取消；并提供开箱即用的 `loadOfficeFile` / `withConversionCache` 管线。

同一 URL 二次打开时跳过下载与转换，近乎秒开。
...
<img src="https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/svg/1f449.svg" width="16" height="16" alt="👉" style="vertical-align: middle;" /> 详细文档：[React 自定义渲染器](./packages/react/README.zh-CN.md#-自定义渲染器) | [Vue 自定义渲染器](./packages/vue/README.zh-CN.md#-自定义渲染器)
...
- **文档**：[opsbli/Pioneer/docs](https://opsbli.github.io/Pioneer/docs/)
- **问题反馈**：[Issue Tracker](https://github.com/opsbli/Pioneer/issues)
...
- <img src="https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/svg/1f41b.svg" width="16" height="16" alt="🐛" style="vertical-align: middle;" /> [提交 Issue](https://github.com/opsbli/Pioneer/issues) 报告问题
- <img src="https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/svg/1f4a1.svg" width="16" height="16" alt="💡" style="vertical-align: middle;" /> [提交 PR](https://github.com/opsbli/Pioneer/pulls) 贡献代码
