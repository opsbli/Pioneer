...
test('file type detection covers documented representative formats', async () => {
  const coreUrl = pathToFileURL(path.join(root, 'packages/core/lib/index.mjs')).href;
...
test('both image renderers use worker-first decoding with fallback', async () => {
  for (const renderer of [
    'packages/react/src/renderers/Image/index.tsx',
    'packages/vue/src/renderers/Image/index.vue',
  ]) {
