...
function App() {
  ...
  const [filePreviewModes, setPioneerModes] = useState<Map<string, boolean>>(new Map());
  ...
  const passwordConfig = passwordInput.trim() ? passwordInput : undefined;
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <div className="container mx-auto px-3 sm:px-4 py-8 sm:py-16">
        ...
        {allFiles.length > 0 && showEmbed && (
          <div className="max-w-6xl mx-auto mb-8 sm:mb-12">
            <h2 className="text-xl sm:text-2xl font-bold text-white mb-2">嵌入式预览 (PioneerEmbed)</h2>
