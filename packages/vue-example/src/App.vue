...
const DOCS_URL = isDev
  ? 'http://localhost:4801/Pioneer/docs/'
  : 'https://opsbli.github.io/Pioneer/docs/';
...
const handleCustomEvent = (e: CustomRendererEventPayload) => {
  ...
  console.log('[Pioneer custom-event]', e);
};
...
interface WatermarkDraft {
  ...
  position: 'tile' | 'center' | 'diagonal';
  rotation: number;
  opacity: number;
  color: string; // 空 = 主题自适应
}
  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <div class="container mx-auto px-3 py-3 sm:px-4 sm:py-4">
        <div class="flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div class="flex items-center gap-1.5 sm:gap-3 flex-shrink-0 ml-auto">
            ...
            <a
              href="https://github.com/opsbli/Pioneer"
              target="_blank"
    ...
    <div class="container mx-auto px-3 sm:px-4 py-8 sm:py-16">
      ...
      <div v-if="allFiles.length > 0 && showEmbed" class="max-w-6xl mx-auto mb-8 sm:mb-12">
        <h2 class="text-xl sm:text-2xl font-bold text-white mb-2">嵌入式预览 (PioneerEmbed)</h2>
    ...
    <footer class="max-w-6xl mx-auto mt-8 sm:mt-12 mb-6 sm:mb-8 px-3 sm:px-4 text-center pb-[env(safe-area-inset-bottom)]">
      <div class="text-gray-400 text-xs sm:text-sm">
        ...
        <p class="flex flex-wrap items-center justify-center gap-1">
          <a
            href="https://github.com/opsbli/Pioneer/blob/master/LICENSE"
            target="_blank"
            rel="noopener noreferrer"
    ...
    >
      ...
      >
        ...
        <div class="space-y-2">
          <div class="flex items-center gap-3">
            <span class="text-gray-400 text-xs w-10 flex-shrink-0">水印</span>
            <button
              :class="['relative w-10 h-5 rounded-full transition-colors', watermarkEnabled ? 'bg-emerald-500' : 'bg-white/20']"
              @click="watermarkEnabled = !watermarkEnabled"
            >
              <span :class="['absolute top-0.5 left-0.5 w-4 h-4 rounded-full bg-white shadow transition-transform', watermarkEnabled ? 'translate-x-5' : '']" />
            </button>
        ...
        <!-- 密码输入 -->
        <div class="space-y-1">
          <span class="text-gray-400 text-xs">密码</span>
          <input
            type="password"
          ...
          />
          <span class="text-gray-600 text-[9px]">留空则使用弹窗输入</span>
        </div>
