<template>
  <div ref="wrapperRef" class="pio-w-full">
    <canvas v-if="renderMode === 'canvas'" ref="canvasRef" class="pio-block" />
    <div
      v-else
      class="pio-w-full pio-text-fg-primary pio-whitespace-pre-wrap pio-break-words"
      :style="{
