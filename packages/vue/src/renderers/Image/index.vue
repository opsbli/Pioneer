...
<template>
  <div
    ref="containerRef"
    class="pio-relative pio-flex pio-items-center pio-justify-center pio-w-full pio-h-full pio-overflow-hidden"
  ...
  >
    ...
    <div
      v-if="decoding"
      class="pio-absolute pio-inset-0 pio-flex pio-flex-col pio-items-center pio-justify-center pio-bg-surface-1/80 pio-z-10"
    >
      <Loader2 class="pio-w-12 pio-h-12 pio-text-fg-primary pio-animate-spin" />
      <p class="pio-mt-4 pio-text-fg-secondary">
    ...
    <div v-if="!loaded && !error && !decoding && !decodeError" class="pio-flex pio-items-center pio-justify-center">
      <div
    ...
    <img
      ...
      :src="imageSrc"
      alt="Preview"
      :class="['pio-max-w-none pio-select-none', (!loaded || error || decodeError) && 'pio-hidden']"
    ...
    <div
      ...
      class="pio-absolute pio-bottom-2 pio-right-3 pio-text-[10px] pio-text-fg-disabled hover:pio-text-fg-secondary pio-transition-colors pio-pointer-events-auto pio-select-none pio-cursor-default"
    >
    ...
    <div
      v-if="totalPages > 1"
      class="pio-absolute pio-bottom-2 pio-left-1/2 -pio-translate-x-1/2 pio-flex pio-items-center pio-gap-2 pio-px-3 pio-py-1.5 pio-bg-surface-toolbar pio-border pio-border-line pio-rounded-lg pio-text-sm pio-text-fg-primary pio-shadow-md"
    >
      <button
        type="button"
        :disabled="currentPage <= 1 || decoding"
        class="pio-px-2 pio-py-0.5 pio-rounded hover:pio-bg-surface-nav-hover disabled:pio-opacity-40 disabled:pio-cursor-not-allowed"
        @click="handlePageChange(currentPage - 1)"
      >
        上一页
      </button>
      <span class="pio-text-fg-secondary pio-tabular-nums">
