...
<template>
  <div
    class="pio-relative pio-w-full pio-h-full pio-flex pio-justify-center pio-bg-surface-1 pio-overflow-hidden"
  >
    <RendererError v-if="error" :message="error" class="pio-absolute pio-inset-0" />

    <div
      v-if="loading && !error"
      class="pio-absolute pio-inset-0 pio-flex pio-items-center pio-justify-center pio-z-10"
    >
    ...
    >
      ...
      >
        <div class="pio-flex pio-items-center pio-justify-between pio-px-4 pio-py-3 pio-border-b pio-border-line-weak pio-flex-shrink-0">
          <span class="pio-text-fg-primary pio-font-medium pio-text-sm">{{ t('toolbar.toc') }}</span>
          <button class="toc-close-btn" @click="showToc = false">
            <X class="pio-w-4 pio-h-4" />
          </button>
        </div>
        <div class="pio-flex-1 pio-overflow-y-auto pio-py-4 pio-px-1">
    ...
    <div
      v-if="!error"
      ref="hostRef"
      class="pio-h-full pio-bg-surface-toolbar pio-shadow-lg"
          ...
          item.href
            ? h(
                'button',
                {
                  ...
                  class: [
                    'pio-w-full pio-text-left pio-py-2 pio-px-3 pio-text-sm pio-rounded pio-transition-all pio-truncate',
            ...
            : h(
                'div',
                { class: 'pio-w-full pio-py-2 pio-px-3 pio-text-sm pio-text-fg-tertiary pio-truncate' },
                item.label?.trim()
              ),
