...
// const watermark = { mode: 'image', imageUrl: '/logo.png', position: 'center', opacity: 0.3 };
</script>
...
<template>
  <div v-if="error" class="pio-text-fg-primary">
...
```vue
<template>
  <div class="pio-bg-surface-1 pio-border pio-border-line-weak pio-rounded">
    <h2 class="pio-text-fg-primary pio-text-lg">Title</h2>
    <p class="pio-text-fg-secondary">Body text</p>
    <button class="pio-bg-surface-2 hover:pio-bg-surface-3 pio-text-fg-primary">
      Click me
    </button>
...
.my-code {
  background: var(--pio-code-bg);
  color: var(--pio-code-fg);
}
</style>
```
...
<div class="pio-text-white/90 pio-bg-white/10 pio-border-white/15">
<div class="pio-text-gray-700 pio-bg-gray-100">
...
<style scoped>
.foo { color: rgba(255, 255, 255, 0.75); }   /* Use var(--pio-fg-secondary) */
.foo { background: #1e1e1e; }                 /* Use var(--pio-code-bg) */
</style>
```
...
- [Full Documentation](https://opsbli.github.io/Pioneer/docs/)
- [Vue Demo](https://opsbli.github.io/Pioneer/vue/)
- [React Demo](https://opsbli.github.io/Pioneer/)
