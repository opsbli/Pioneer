...
export const VideoRenderer = forwardRef<RendererHandle, VideoRendererProps>(({ url, fileName }, ref) => {
  ...
  return (
    <div className="pio-flex pio-items-center pio-justify-center pio-w-full pio-h-full">
      <div className="pio-w-full pio-h-full pio-relative">
        {/* 加载状态 */}
        {isLoading && (
          <div className="pio-absolute pio-inset-0 pio-flex pio-items-center pio-justify-center pio-bg-surface-3 pio-backdrop-blur-sm pio-z-10">
            <div className="pio-text-center">
              <div className="pio-w-12 pio-h-12 pio-mx-auto pio-mb-3 pio-border-3 pio-border-line-strong pio-border-t-spinner-head pio-rounded-full pio-animate-spin" />
              <p className="pio-text-sm pio-text-fg-secondary pio-font-medium">{t('video.loading')}</p>
            </div>
          </div>
        )}
        ...
        <div
          ref={videoRef}
          className="pio-overflow-hidden pio-w-full pio-h-full [&_video]:pio-object-contain"
          style={{
