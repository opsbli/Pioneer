...
export const CadRenderer = forwardRef<RendererHandle, CadRendererProps>(({ url, file, fileName }, ref) => {
  ...
  return (
    <div ref={containerRef} className="pio-relative pio-w-full pio-h-full pio-bg-media-bg">
      {/* 错误覆盖层 */}
      {error && (
        <div className="pio-absolute pio-inset-0 pio-flex pio-items-center pio-justify-center pio-bg-surface-3 pio-z-10">
          <div className="pio-text-center">
            <p className="pio-text-fg-primary">{error}</p>
          </div>
        </div>
      )}
      ...
      {loading && (
        <div className="pio-absolute pio-inset-0 pio-flex pio-items-center pio-justify-center pio-bg-surface-3 pio-z-10">
          <div className="pio-text-center">
            <div className="pio-inline-block pio-w-8 pio-h-8 pio-border-4 pio-border-spinner-track pio-border-t-spinner-head pio-rounded-full pio-animate-spin" />
            <p className="pio-mt-4 pio-text-fg-secondary">{t('cad.loading')}</p>
          </div>
        </div>
      )}
    </div>
