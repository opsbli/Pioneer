...
export const enUS: Messages = {
  ...
  // ─────── encrypted ───────
  'encrypted.title': 'File requires password',
  'encrypted.password_placeholder': 'Enter password',
  'encrypted.confirm': 'Confirm',
  'encrypted.error': 'Incorrect password, please retry',
  'encrypted.max_attempts': 'Maximum retry attempts reached, cannot open file',
  'encrypted.retries_left': '{count} retries remaining',
  'encrypted.waiting': 'Waiting for password...',
  'encrypted.protected': 'File is password protected, please download and open with Office',
  ...
  'search.prev_match': 'Previous match',
