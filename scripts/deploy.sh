...
# 构建 core 共享包
echo "构建 core..."
pnpm --filter @pioneer/core build
...
echo "复制 React 示例项目..."
cp -r packages/react-example/dist/* dist-deploy/
...
# 构建文档站点
echo "构建文档站点..."
pnpm --filter @pioneer/docs build
...
if [ -n "$GITHUB_ACTIONS" ]; then
  ...
  git push -f https://x-access-token:${GITHUB_TOKEN}@github.com/opsbli/Pioneer.git HEAD:gh-pages
else
  echo "本地环境，使用 SSH 推送..."
  git push -f git@github.com:opsbli/Pioneer.git HEAD:gh-pages
fi
...
echo "部署完成！"
echo "React 示例: https://opsbli.github.io/Pioneer/"
echo "Vue 示例:   https://opsbli.github.io/Pioneer/vue/"
echo "文档站点:   https://opsbli.github.io/Pioneer/docs/"
